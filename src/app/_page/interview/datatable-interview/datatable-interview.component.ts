...
@Component({
  selector: 'app-datatable-interview',
  templateUrl: './datatable-interview.component.html',
  styleUrls: ['./datatable-interview.component.css']
})
export class DatatableInterviewComponent implements OnInit, OnDestroy {
  ...
  update(ev){
    console.log(ev);
    this.router.navigate(['interview/edit/'+ev])
  }

  hasilInterview(ev){
    this.router.navigate(['hasil-interview/'+ev]);
  }
