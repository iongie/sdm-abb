...
@Component({
  selector: 'app-datatable-kontrak-kerja',
  templateUrl: './datatable-kontrak-kerja.component.html',
  styleUrls: ['./datatable-kontrak-kerja.component.css']
})
export class DatatableKontrakKerjaComponent implements OnInit {
  ...
  update(ev){
    console.log(ev);
    this.router.navigate(['data-pegawai/edit/'+ev])
  }
