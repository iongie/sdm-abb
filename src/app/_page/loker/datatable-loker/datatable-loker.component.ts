...
@Component({
  selector: 'app-datatable-loker',
  templateUrl: './datatable-loker.component.html',
  styleUrls: ['./datatable-loker.component.css']
})
export class DatatableLokerComponent implements OnInit {
  ...
  update(ev){
    console.log(ev);
    this.router.navigate(['lowongan-kerja/edit/'+ev])
  }

  kandidat(ev){
    this.router.navigate(['kandidat/add/'+ev]);
  }
