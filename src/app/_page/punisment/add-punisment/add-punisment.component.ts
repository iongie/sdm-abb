...
@Component({
  selector: 'app-add-punisment',
  templateUrl: './add-punisment.component.html',
  styleUrls: ['./add-punisment.component.css']
})
export class AddPunismentComponent implements OnInit, OnDestroy {
  ...
  cancel(){
    this.router.navigate(['/punisment/view']);
  }
