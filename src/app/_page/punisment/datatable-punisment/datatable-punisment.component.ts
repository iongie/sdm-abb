...
@Component({
  selector: 'app-datatable-punisment',
  templateUrl: './datatable-punisment.component.html',
  styleUrls: ['./datatable-punisment.component.css']
})
export class DatatablePunismentComponent implements OnInit, OnDestroy {
