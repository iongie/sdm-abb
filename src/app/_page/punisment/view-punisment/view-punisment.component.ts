...
@Component({
  selector: 'app-view-punisment',
  templateUrl: './view-punisment.component.html',
  styleUrls: ['./view-punisment.component.css']
})
export class ViewPunismentComponent implements OnInit, OnDestroy {
