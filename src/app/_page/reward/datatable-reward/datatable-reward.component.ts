...
@Component({
  selector: 'app-datatable-reward',
  templateUrl: './datatable-reward.component.html',
  styleUrls: ['./datatable-reward.component.css']
})
export class DatatableRewardComponent implements OnInit, OnDestroy {
